...
import DemoEmailSender from '../components/admin/DemoEmailSender';
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
            ...
            <p className="text-3xl font-bold text-white">{stats?.counts.ideas || 0}</p>
        ...
        <div className="flex gap-4 mb-6 mt-8">
          ...
          <button
            ...
            className="px-4 py-2 bg-gray-800 text-gray-400 hover:text-white rounded-lg transition-colors flex items-center gap-2"
          >
